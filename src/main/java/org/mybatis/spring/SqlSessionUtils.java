...
public final class SqlSessionUtils {
  ...
  public static SqlSession getSqlSession(SqlSessionFactory sessionFactory, ExecutorType executorType,
    ...
    /**
     * 从 TransactionSynchronizationManager 事务同步管理器 中拿到SqlSession的助手类 其实这里是从缓存中去那SqlSessionHolder ，该holder中有SqlSession 重点
     * 根据SqlSessionFactory从TransactionSynchronizationManager中获取SqlSessionHolder,
     * 这里的SqlSession就是从TransactionSynchronizationManager的 ThreadLocal 以sqlSessionFactory 为key获取到的
     */
     ...
     *
     * 和spring事务管理器的结合可以看这里
     */
    session = sessionFactory.openSession(executorType);

    /**
     * 这里会把SqlSession交给SqlSessionHolder ，然后缓存到 TransactionSynchronizationManager 中的一个 ThreadLocal<Map<Object, Object>>
     * resources中
     *
