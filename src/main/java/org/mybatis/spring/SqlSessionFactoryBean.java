...
public class SqlSessionFactoryBean
  ...
  protected SqlSessionFactory buildSqlSessionFactory() throws Exception {
    ...
    /**
     * 配置事务管理类，将不再由MyBatis管理（之前配置为“JDBC”对应的MyBatis的JdbcTransactionFactory)。 创建 Environment 把
     * SpringManagedTransactionFactory 和 dataSource保存进去 如果有指定transactionFactory
     * 就使用指定的，否则就使用SpringManagedTransactionFactory
     */
